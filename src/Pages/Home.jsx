                    ...
                    <div key={item.name} className="rounded-[10px] bg-white p-6 shadow-1 dark:bg-gray-dark shadow card">
                     ...
                     {item.icon}
                      <div class="mt-6 flex items-end justify-between">
                        <dl>
                          <dt class="mb-1.5 text-heading-6 font-bold text-dark dark:text-white text-[24px] ">{item.value}</dt>
                          <dd class="text-sm font-medium text-dark-6 text-[#8D8D8D]">{item.name}</dd>
                        </dl>
                        <dl class="text-sm font-medium text-[#22AD5C]">
                          <dt class="flex items-center gap-1.5">{item.change}
