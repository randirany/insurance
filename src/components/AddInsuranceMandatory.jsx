...
function AddInsuranceMandatory({ onClose, isOpen }) {
                ...
                <form className="mt-2 space-y-4 rounded-md border border-gray-300 ">
                    ...
                    <div className="grid grid-cols-2 gap-3 px-4">
                        <div>
                            ...
                            <input type="date" className="w-full p-2 border rounded-md" placeholder="Enter Vehicle Name" />
                        </div>
                        <div>
                            <label className="block text-sm font-medium">End Date </label>
                            <input type="date" className="w-full p-2 border rounded-md" placeholder="Enter Vehicle Number" />
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <input type="text" className="w-full p-2 border rounded-md" placeholder="Enter Paid Amount" />
                        </div>
                        <div>
                            <label className="block text-sm font-medium">Payment Date </label>
                            <input type="date" className="w-full p-2 border rounded-md" placeholder="Enter Paid Amount" />
                        </div>
                    ...
                    <div className='px-4'>
                        ...
                        <div
                            ...
                            ref={dropAreaRef}
                            className={`w-full max-w-[974px] relative flex cursor-pointer h-[60px] flex-col items-center justify-center h-64 border-1 rounded-md bg-[#DEE4EE] ${isDragging ? "border-[#5750F1] bg-[#5750F1]/5" : "border-gray-300"
                                }`}
