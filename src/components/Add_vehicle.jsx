...
function Add_vehicle({ onClose, isOpen }) {
    console.log(isOpen)
                ...
                <form className="mt-2 space-y-4 rounded-md border border-gray-300 ">
                    ...
                    <div className="grid grid-cols-2 gap-3 px-4">
                        ...
                        <div>
                            ...
                            <input type="text" className="w-full p-2 border rounded-md" placeholder="Enter Vehicle Price" />
                        </div>
                        <div>
                    ...
                    <div className='px-4'>
                        ...
                        <div
                            ...
                            ref={dropAreaRef}
                            className={`w-full max-w-[974px] relative flex cursor-pointer h-[110px] flex-col items-center justify-center h-64 border-1 rounded-md bg-[#DEE4EE] ${isDragging ? "border-[#5750F1] bg-[#5750F1]/5" : "border-gray-300"
                                }`}
                  ...
                  Browse files
                    ...
                    <div className="flex justify-end px-4 ">
                        <input type="submit" value='Submit' className="px-4 py-2 text-white w-full bg-indigo-600 rounded-md hover:bg-indigo-500" />
