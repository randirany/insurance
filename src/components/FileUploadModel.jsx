...
function FileUploadModal({ isOpen, onClose, onUpload }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
      <div className="w-full max-w-[1000px] bg-white rounded-lg shadow-lg h-auto max-h-[90vh] ">
        <div className="flex items-center justify-between p-4 border-b-[.5px] border-gray-300 ">
