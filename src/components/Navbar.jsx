...
function Navbar({ setSidebarOpen, sidebarOpen }) {
  ...
  //   },[open])
  return (
    <div className={`  border-b-[1.5px] py-2 z-10 bg-white  fixed top-0 ${language == "en" ? "right-0" : "left-0"}  2md:w-[78%]    w-[100%]`}>
              ...
              <button className="rounded align-middle outline-none ring-primary ring-offset-2 focus-visible:ring-1 dark:ring-offset-gray-dark" aria-expanded="false" aria-haspopup="menu" data-state="closed"><span className="sr-only">My Account</span>
                <figure className="flex items-center gap-3" onClick={toggleProfile}>
                  ...
                  <figcaption className="flex items-center gap-1 font-medium text-dark dark:text-dark-6 max-[1024px]:sr-only">
                    ...
                    <svg width="22" height="22" viewBox="0 0 22 22" fill="currentColor" aria-hidden="true" className={`${profileOpen ? "transition-transform rotate-0" : "rotate-180 transition-transform"}`} stroke-width="1.5"><path fillRule="evenodd" clipRule="evenodd" d="M10.551 7.728a.687.687 0 01.895 0l6.417 5.5a.687.687 0 11-.895 1.044l-5.97-5.117-5.969 5.117a.687.687 0 01-.894-1.044l6.416-5.5z"></path>
                    </svg>
                  </figcaption>
                </figure>
              </button>
