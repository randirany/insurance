    ...
    <div>
      <div className={`bg-white sidebar   w-[22%] py-[20px] px-2  md:px-4    2sm:w-[22%] fixed top-0  ${language == "en" ? "left-0 border-r" : "right-0 border-l"} bottom-0 z-11`}>
        ...
        <div className='custom-scrollbar mt-6 flex-1 pr-3 min-[850px]:mt-10  overflow-y-scroll h-[calc(100%-50px)]'>
          <div class="mb-4">
            ...
            <nav role="navigation" aria-label="MAIN MENU">
              <ul class="space-y-2">
                ...
                <li>
                  <div>
                    <button aria-expanded="true" class="rounded-lg px-3.5 font-medium text-dark-4 transition-all duration-200 dark:text-dark-6 bg-[rgba(87,80,241,0.07)] text-primary hover:bg-[rgba(87,80,241,0.07)] dark:bg-[#FFFFFF1A] dark:text-white flex w-full items-center gap-3 py-3">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M6.5 1.75C3.87665 1.75 1.75 3.87665 1.75 6.5C1.75 9.12335 3.87665 11.25 6.5 11.25C9.12335 11.25 11.25 9.12335 11.25 6.5C11.25 3.87665 9.12335 1.75 6.5 1.75ZM3.25 6.5C3.25 4.70507 4.70507 3.25 6.5 3.25C8.29493 3.25 9.75 4.70507 9.75 6.5C9.75 8.29493 8.29493 9.75 6.5 9.75C4.70507 9.75 3.25 8.29493 3.25 6.5Z" fill="#111928" />
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M17.5 12.75C14.8766 12.75 12.75 14.8766 12.75 17.5C12.75 20.1234 14.8766 22.25 17.5 22.25C20.1234 22.25 22.25 20.1234 22.25 17.5C22.25 14.8766 20.1234 12.75 17.5 12.75ZM14.25 17.5C14.25 15.7051 15.7051 14.25 17.5 14.25C19.2949 14.25 20.75 15.7051 20.75 17.5C20.75 19.2949 19.2949 20.75 17.5 20.75C15.7051 20.75 14.25 19.2949 14.25 17.5Z" fill="#111928" />
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M12.75 6.5C12.75 3.87665 14.8766 1.75 17.5 1.75C20.1234 1.75 22.25 3.87665 22.25 6.5C22.25 9.12335 20.1234 11.25 17.5 11.25C14.8766 11.25 12.75 9.12335 12.75 6.5ZM17.5 3.25C15.7051 3.25 14.25 4.70507 14.25 6.5C14.25 8.29493 15.7051 9.75 17.5 9.75C19.2949 9.75 20.75 8.29493 20.75 6.5C20.75 4.70507 19.2949 3.25 17.5 3.25Z" fill="#111928" />
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M6.5 12.75C3.87665 12.75 1.75 14.8766 1.75 17.5C1.75 20.1234 3.87665 22.25 6.5 22.25C9.12335 22.25 11.25 20.1234 11.25 17.5C11.25 14.8766 9.12335 12.75 6.5 12.75ZM3.25 17.5C3.25 15.7051 4.70507 14.25 6.5 14.25C8.29493 14.25 9.75 15.7051 9.75 17.5C9.75 19.2949 8.29493 20.75 6.5 20.75C4.70507 20.75 3.25 19.2949 3.25 17.5Z" fill="#111928" />
                      </svg>

                      <span>{t("sideBar.mainMenu.categore.insucresComp.titleInsucresComp")}</span>
                      <svg width="16" height="8" viewBox="0 0 16 8" fill="currentColor" class="ml-auto transition-transform duration-200 rotate-0" aria-hidden="true"><path fill-rule="evenodd" clip-rule="evenodd" d="M7.553.728a.687.687 0 01.895 0l6.416 5.5a.688.688 0 01-.895 1.044L8 2.155 2.03 7.272a.688.688 0 11-.894-1.044l6.417-5.5z"></path></svg>
                    </button>
                    <ul class="ml-9 mr-0 space-y-1.5 pb-[15px] pr-0 pt-2" role="menu">
                      <li role="none" onClick={() => {
                        setIsOpenMandatory(true)
                      }}>
                        <a class="rounded-lg px-3.5 font-medium transition-all duration-200  hover:bg-[rgba(87,80,241,0.07)] dark:bg-[#FFFFFF1A] dark:text-white relative block py-2" >
                      ...
                      <li role="none" onClick={() => {
                        ...
                        <a class="rounded-lg px-3.5 font-medium text-dark-4 transition-all duration-200 dark:text-dark-6 hover:bg-gray-100 hover:text-dark hover:dark:bg-[#FFFFFF1A] hover:dark:text-white relative block py-2" >
                          <span>{t("sideBar.mainMenu.categore.insucresComp.categore.Third")}</span>
                          {/* <span class="absolute right-3.5 top-1/2 flex h-5 -translate-y-1/2 items-center justify-center rounded-md bg-primary px-1.5 text-xs text-white">Pro</span> */}
                        </a>
                      </li>
                      <li role="none" onClick={()=>{
                        setIsOpenFull(true)
                      ...
                      <li role="none">
                        {/* <a class="rounded-lg px-3.5 font-medium text-dark-4 transition-all duration-200 dark:text-dark-6 hover:bg-gray-100 hover:text-dark hover:dark:bg-[#FFFFFF1A] hover:dark:text-white relative block py-2" href="/crm"><span>CRM</span><span class="absolute right-3.5 top-1/2 flex h-5 -translate-y-1/2 items-center justify-center rounded-md bg-primary px-1.5 text-xs text-white">Pro</span>
                      </a> */}
                      </li>
                ...
                <li>
                  <div>
                    <button aria-expanded="false" class="rounded-lg px-3.5 font-medium text-dark-4 transition-all duration-200 dark:text-dark-6 hover:bg-gray-100 hover:text-dark hover:dark:bg-[#FFFFFF1A] hover:dark:text-white flex w-full items-center gap-3 py-3">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      {/* <svg width="16" height="8" viewBox="0 0 16 8" fill="currentColor" class="ml-auto rotate-180 transition-transform duration-200" aria-hidden="true"><path fill-rule="evenodd" clip-rule="evenodd" d="M7.553.728a.687.687 0 01.895 0l6.416 5.5a.688.688 0 01-.895 1.044L8 2.155 2.03 7.272a.688.688 0 11-.894-1.044l6.417-5.5z"></path></svg> */}
                    </button>
                  </div>
                </li>
                <li>
                ...
                <li>
                  <div>
                    ...
                    <ul class="ml-9 mr-0 space-y-1.5 pb-[15px] pr-0 pt-2" role="menu">
                      <li role="none">
                        <a class="rounded-lg px-3.5 font-medium transition-all duration-200 bg-[rgba(87,80,241,0.07)] text-primary hover:bg-[rgba(87,80,241,0.07)] dark:bg-[#FFFFFF1A] dark:text-white relative block py-2" href="/">
                          <span>{t("sideBar.mainMenu.categore.report.categore.insuranceRep")}</span>
                        </a>
                      </li>
                      <li role="none">
                        <a class="rounded-lg px-3.5 font-medium text-dark-4 transition-all duration-200 dark:text-dark-6 hover:bg-gray-100 hover:text-dark hover:dark:bg-[#FFFFFF1A] hover:dark:text-white relative block py-2" href="/analytics">
                          <span>{t("sideBar.mainMenu.categore.report.categore.DealersRep")}</span>
                          {/* <span class="absolute right-3.5 top-1/2 flex h-5 -translate-y-1/2 items-center justify-center rounded-md bg-primary px-1.5 text-xs text-white">Pro</span> */}
                        </a>
                      </li>
          ...
          <div class="mb-4">
            <h2 class="mb-2 px-3 text-sm font-medium text-dark-4 dark:text-dark-6 uppercase">{t("sideBar.support.title")} </h2>
            <nav role="navigation" aria-label="MAIN MENU">
              <ul class="space-y-2">
                <li>
                  <a class="rounded-lg px-3.5 font-medium text-dark-4 transition-all duration-200 dark:text-dark-6 hover:bg-gray-100 hover:text-dark hover:dark:bg-[#FFFFFF1A] hover:dark:text-white relative flex items-center gap-3 py-3" href="/calendar">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div class="mb-4">
            <h2 class="mb-2 px-3 text-sm font-medium text-dark-4 dark:text-dark-6 uppercase">{t("sideBar.settings.title")} </h2>
                ...
                <li>
                  <div>
                    ...
                    <ul class="ml-9 mr-0 space-y-1.5 pb-[15px] pr-0 pt-2" role="menu">
                      ...
                      <li role="none">
                        <a class="rounded-lg px-3.5 font-medium text-dark-4 transition-all duration-200 dark:text-dark-6 hover:bg-gray-100 hover:text-dark hover:dark:bg-[#FFFFFF1A] hover:dark:text-white relative block py-2" href="/analytics">
                          <span>{t("sideBar.settings.auth.categore.signUp")}</span>
                          {/* <span class="absolute right-3.5 top-1/2 flex h-5 -translate-y-1/2 items-center justify-center rounded-md bg-primary px-1.5 text-xs text-white">Pro</span> */}
                        </a>
                      </li>
                      <li role="none">
      ...
      <AddInsuranceMandatory isOpen={isOpenMandatory} onClose={setIsOpenMandatory} />
      <AddInsuranceThiry isOpen={isOpenThird} onClose={setIsOpenThird} />
      <AddInsuranceFull isOpen={isOpenFull} onClose={setIsOpenFull} />
    </div>
